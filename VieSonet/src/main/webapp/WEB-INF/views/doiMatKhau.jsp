            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/dieukhoan"><small style=" white-space: nowrap;
                                overflow: hidden; 
        ...
        <div class="container"
            ...
            <div class="row" style="padding: 0; border-radius: 10px;">
                ...
                <div class="col-md-7 col-sm-12 img-thumbnail  animate__animated animate__backInRight"
                    ...
                    <form action="/doimatkhau" modelAttribute="doiMatKhau" method="post" style="text-align: left;width: 100%; ">
                        <div class="row">
                            <center>
