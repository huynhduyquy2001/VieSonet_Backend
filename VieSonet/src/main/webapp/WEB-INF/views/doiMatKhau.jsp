			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="collapsibleNavId">
					...
					<ul class="navbar-nav ms-auto mt-2 mt-lg-0">
						...
						<li class="nav-item"><a class="nav-link" href=""><small
								style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-family: 'Roboto', sans-serif; letter-spacing: 0.1em;"><button
										class="btnBorder" id="registerBtn">Đăng ký</button></small></a></li>
					</ul>
				</div>
	...
	<div>
		<div class="container"
			...
			<div class="row" style="padding: 0; border-radius: 10px;">
				...
				<div
					class="col-md-7 col-sm-12 img-thumbnail  animate__animated animate__backInRight"
					...
					<form action="/doimatkhau" modelAttribute="doiMatKhau"
						method="post" style="text-align: left; width: 100%;">
						<div class="row">
							<center>
								<h6 style="color: #3B998B;">
									<b>Đổi mật khẩu</b>
								</h6>
								${message }
								<hr style="width: 30%;">
							...
							<div class="mb-3 text">
								<center>
									<input type="password" class="form-control ip" name="matKhau"
										id="" aria-describedby="helpId" placeholder="Mật khẩu cũ?"
										required>
								</center>
							</div>
							<div class="mb-3">
								<center>
									<input type="password" class="form-control ip"
										name="matKhauMoi" id="" aria-describedby="helpId"
							...
							<div class="mb-3">
								<center>
									<input type="password" class="form-control ip"
										name="matKhauXacNhan" id="" aria-describedby="helpId"
						...
						<c:if test="${passwordChanged}">
							<div class="alert alert-success">
								Đổi mật khẩu thành công. Bạn muốn <a href="/dangxuat">đăng
									xuất</a> hay <a href="/">trở lại trang chủ</a>?
							</div>
						</c:if>
						<center>
