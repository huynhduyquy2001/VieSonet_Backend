				...
				<div class="col-1">
					...
					<div class="dropdown">
						<button class="btn dropdown-toggle text-white" type="button"
							...
							aria-expanded="false">
							<i class="fa fa-cog text-white"></i> <b style="color: white;"></b>
						</button>
						<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton"">
							<li><button data-bs-toggle="modal" data-bs-target="#modalId"
									style="border: 1px solid white; border-radius: 6px; background-color: white;">
					...
					<div class="modal-footer post-upload-textarea"
						...
						<div class="input-group mb-3">
							<label class="input-group-text" for="inputGroupFile011"><img
								...
								style="width: 20px; margin-right: 13px;">Hình ảnh</label> <input
					...
					<div class="modal-body">
						<ul style="line-height: 30px;">
							...
							<li><i class="fa-regular fa-heart"></i> <b>Mối quan hệ:</b>
								...
								style="border: none; background-color: transparent; border-bottom: 1px solid gray; border-radius: 0;">
	...
	<div class="container">
		<div class="row">
					...
					<div
						...
						<div class="write-post-container nenTrangChu img-thumbnail"
							...
							<div class="user-profile">
								...
								<div>
									<label>${nguoiDung.hoTen}</label> <br> <small>
			...
			<div class="col-md-7 offset-md-5">
				<div style="box-sizing: border-box; margin: 1%; padding: 1%;">
					<c:if test="${nguoiDung.gioiThieu}!=null">
						<center>
							<div>
								<br> ${nguoiDung.gioiThieu}
							</div>
						</center>
					</c:if>
							...
							<c:forEach items="${BaiVietCaNhan}" var="BaiViet">
								...
								<div class="col-md-4">
									<div onclick="loadBinhLuan(${BaiViet.maBaiViet})">
										<center>
											<img class="lazy "
												data-src="images/${BaiViet.hinhAnh}" width="100%" alt=""
												style="margin-top: 10px; margin-bottom: 10px; border-radius: 6px;">
										</center>
									</div>
								</div>
	...
	<div class="modal fade" id="exampleModalToggle" aria-hidden="true"
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content"
				...
				<form action="/profile/dangbai" method="post" name="baiDang"
					enctype="multipart/form-data">
					<div class="modal-body">
...
<!-- Modal chỉnh sửa bài viết -->
	...
	<!-- load ảnh chỉnh sửa -->
	<script>
        let img2 = document.getElementById('hinhAnhCuaToi');
        let input2 = document.getElementById('inputMyGroupFile');
